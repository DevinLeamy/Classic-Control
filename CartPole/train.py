...
class DQN():
    def __init__(self, states_cnt, hidden_cnt, actions_cnt, lr=0.01, gamma=0.99, batch_sz=64, memory_sz=1000, update_fq=200):
    ...
    def store_model(self):
        torch.save(self.q_net.state_dict(), "models/CartPoleModel.pt")
        print("Model Saved")
...
def train(problem, episodes, max_iterations, gamma, epsilon, epsilon_decay, lr, threshold_value):
    ...
    for episode in range(episodes):
        ...
        for _iter in range(max_iterations):
            ...
            records.append([episode, _iter + 1, rewards])
...
records = train("CartPole-v0", 300, 200, 0.9, 1.0, 0.9, 0.001, 250)
